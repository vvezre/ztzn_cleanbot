 ...
 * 验证关键方法的语法和逻辑正确性
 */
public class TestD12Verification {
    ...
    public static void main(String[] args) {
        ...
        String productModel = hexToASCII(d12Data.substring(16, 24));
        System.out.println("提取的产品型号: " + productModel);
        String deviceType = ("-D12".equals(productModel) || "-T12".equals(productModel)) ? "D12_接驳车" : "标准设备";
        System.out.println("识别结果: " + deviceType);
        System.out.println();
